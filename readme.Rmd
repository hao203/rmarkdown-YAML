...
Then, wherever you want to include the value for the variable named `hashtag`, simply use `params$<parameter name>`, as in the title shown here or in later code chunks or inline R code. e.g.
...
We will contine to summarize the YAML options of related packages (e.g. distill, rticles, bookdown, rmdformats )
